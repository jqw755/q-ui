...
var QButton = _export_sfc(_sfc_main$3, [["__scopeId", "data-v-0b80682a"]]);
QButton.install = (app) => {
  app.component(QButton.name, QButton);
};
var _hoisted_1$1 = ["title"];
var _hoisted_2$1 = ["title", "onMouseenter", "onClick"];
...
var QSelect = _export_sfc(_sfc_main$2, [["__scopeId", "data-v-10eaefa2"]]);
QSelect.install = (app) => {
  app.component(QSelect.name, QSelect);
};
var _withScopeId = (n) => (pushScopeId("data-v-6e1538d3"), n = n(), popScopeId(), n);
...
var _hoisted_4 = _withScopeId(() => createBaseVNode("div", { class: "assist" }, null, -1));
...
var QBreadcrumb = _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6e1538d3"]]);
...
var components = [QButton, QSelect, QBreadcrumb, _sfc_main];
var install = (app) => {
