...
// return fetch('https://api.github.com/repos/themusecatcher/q-ui/contents/package.json?ref=master', {
//   headers: {
...
export function fetchVersion() {
  return fetch("https://raw.githubusercontent.com/jqw755/q-ui/master/package.json")
    .then((res) => res.json())
